...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      return redirect()->back()->with('success','post berhasil di upload');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success','Posts berhasil dihapus (silahkan dek trashed post)');
    }
    ...
    public function kill($id){
      $post = Posts::withTrashed()->where('id', $id)->first();
      $post->forceDelete();
      return redirect()->route('post.index')->with('success','post berhasil di hapus all');
